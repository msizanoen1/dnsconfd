...
class SystemManager:
    ...
    HEADER_RESOLVE1 = "# Generated by dnsconfd (systemd-resolved compatible)\n"
    ...
    def __init__(self, config: dict):
        ...
        self._api_choice = config["api_choice"]
    ...
    def get_resolvconf_string(self, search_domains=None):
        if search_domains is None:
            search_domains = []
        conf = self.HEADER
        if self._api_choice == "resolve1":
            conf = self.HEADER_RESOLVE1
